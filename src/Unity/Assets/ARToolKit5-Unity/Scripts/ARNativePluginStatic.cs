...
public static class ARNativePluginStatic
{
	...
	[DllImport("__Internal")]
	[return: MarshalAsAttribute(UnmanagedType.I1)]
	public static extern int arwGetTrackedMarkerPosition(int index, [MarshalAs(UnmanagedType.LPArray, SizeConst=12)] float[] vertex, out int markerID);

	[DllImport("__Internal")]
	[return: MarshalAsAttribute(UnmanagedType.I1)]
	public static extern bool arwGetIdeal2Observed (float ix, float iy, out float ox, out float oy);
